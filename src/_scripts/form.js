  ...
  $(document).ready(function () {
    ...
    $('.signin__btn-otp').on('click', function (e) {
      if($(this).parents('.form').find('.form__input').not(':disabled').val() !== '' && (!$(this).parents('.form').find('#mobileNumber').hasClass('error'))) {
        ...
        $('.js-form-btn-signin .signin__btn-submit, .js-signin-otp, .js-show-resend-otp').css('display', 'block');
    ...
    $('.js-signin-alternate').clickToggle( function () {
      $('.js-signin-password input').attr('disabled', true);
      $('.js-form-btn-signin .button-primary').css('display', 'none');
      $('.js-form-btn-signin .signin__btn-otp').css('display', 'block');
      $(this).parents('.form__signin').find('.js-signin-password, .signin--forgot-password, .signin__register-link').fadeOut();
    }, function () {
      $('.js-signin-password input').attr('disabled', false);
      $('.js-form-btn-signin .button-primary').css('display', 'none');
      $('.js-form-btn-signin .signin__btn-cta').css('display', 'block');
    ...
    $('.js-resend-otp').on('click', function () {
