...
(function(dmUIConfig) {
  $(document).ready(function () {
    ...
    $('.md-custom-select .cart-details-dropdown, .js-filter-sortby, .product-details .product-details__btn-quantity select, .product-listing__quantity-secondary select').selectric({
      maxHeight: 170
    });
