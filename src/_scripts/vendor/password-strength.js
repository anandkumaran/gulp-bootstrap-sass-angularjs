        jQuery(document).ready(function () {
            ...
            $('#showHidePassword').pwstrength(options);
        });
...
(function ($) {
    ...
    var options = {
            ...
            ruleScores: {
                ...
                wordOneNumber: 3,
                wordThreeNumbers: 5,
                wordOneSpecialChar: 8,
                wordTwoSpecialChar: 10,
                wordUpperLowerCombo: 5,
                wordLetterNumberCombo: 8,
        ...
        setProgressBar = function ($el, score) {
            ...
            console.log(score < options.scores[0]);

            if (score <= options.scores[0]) {
                progressbar.addClass("progress-password--danger").removeClass("progress-password--warning progress-password--medium progress-password--success");
                progressbar.find(".bar").css("width", "5%");
                if (options.showVerdicts) {
                    $verdict.text(options.verdicts[0]);
                }
            } else if (score >= options.scores[0] && score <= options.scores[1]) {
                progressbar.addClass("progress-password--warning").removeClass("progress-password--danger progress-password--medium progress-password--success");
                ...
                progressbar.addClass("progress-password--medium").removeClass("progress-password--warning progress-password--danger progress-password--success");
                progressbar.find(".bar").css("width", "75%");
                if (options.showVerdicts) {
                    $verdict.text(options.verdicts[3]);
                }
            } else if (score >= options.scores[3]) {
                progressbar.addClass("progress-password--success").removeClass("progress-password--medium progress-password--warning progress-password--danger");
        ...
        progressWidget = function () {
            return '<div class="progress-password"><div class="bar"></div></div>';
        },
        ...
        methods = {
            ...
            destroy: function () {
                this.each(function (idx, el) {
                    ...
                    $el.parent().find("div.progress-password").remove();
